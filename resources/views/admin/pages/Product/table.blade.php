            ...
            <div class="col-md-4">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <span id="error" class="error mt-2 d-lg-block w-100"
                              style="font-size: 14px; margin-left: 18px; color: #ff7675!important;"></span>
                    </div>
                    {{-- loaij sach  --}}
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <span id="error2" class="error mt-2 d-lg-block w-100"
                              style="font-size: 14px; margin-left: 18px; color: #ff7675!important;"></span>
                    </div>
                    <div class="form-group">
                        <label>tác giả</label>
                        <input type="text" id="author" class="form-control">
                        <span id="error3" class="error mt-2 d-lg-block w-100"
                              style="font-size: 14px; margin-left: 18px; color: #ff7675!important;"></span>
                    </div>
